...
<head>
    ...
    <title>Yeu cau dich vu cua toi</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<div class="container">
    ...
    <div class="toolbar">
        <form method="get"
              action="${pageContext.request.contextPath}/my-service-requests"
              class="search-form">
            <div class="toolbar-row">
                <div style="display:flex;gap:10px;
                    ...
                    <input type="text"
                           name="search"
                           placeholder="Tim theo ma, chu de..."
                           value="${searchValue}">
                ...
                <div style="display:flex;gap:10px;
                    ...
                    <a href="${pageContext.request.contextPath}/management/service-requests/create"
        ...
        <c:choose>
            <c:when test="${empty requests}">
                <div style="text-align:center;
                    ...
                    <p>Ban chua tao yeu cau dich vu nao</p>
                </div>
            </c:when>
            <c:otherwise>
                <table>
                ...
                <c:if test="${totalPages > 1}">
                    <div class="pagination">
                        <c:if test="${currentPage > 1}">
                            <a href="?page=${currentPage - 1}&search=${searchValue}&status=${statusValue}&requestType=${requestTypeValue}">
                                Truoc
                            </a>
                        </c:if>
                        ...
                        <c:forEach begin="1"
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a href="?page=${i}&search=${searchValue}&status=${statusValue}&requestType=${requestTypeValue}">
                                        ${i}
                                    </a>
                                </c:otherwise>
                            </c:choose>
